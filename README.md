...
- **givenSamplesHavingContinuousRange_whenChargingSession_thenReturnRangeAndReadings** the name of a **passing** test
- **givenSamplesAsEmpty_whenChargingSession_thenReturnEmptyString** the name of a **failing** test
